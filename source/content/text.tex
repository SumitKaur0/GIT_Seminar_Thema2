...
The color distance is an important factor for the readability of maps. This has also been demonstrated by e.g. \textcite{brychtovaC2015,brychtova2015, brychtovaV2014,brychtovaC2016}.
...
In the following chapter critirias will be introduced which affects how humans differentiate colors on a choropletic map. This is mainly affected by the color distance but there are also other aspects which can create difficulties when reading the colors of a map.
...
While the color distance of course has the biggest impact on human abbility to differentiate colors there are some other aspects which play a role. 
...
Irgendwas über color modell.

It can be concluded that the ability to distinguish colors on a choropleth map is mainly influenced by the color distance. The color distance is a measure to quantify the difference between two colors or shades of a color from the perspective of the human eye. 
