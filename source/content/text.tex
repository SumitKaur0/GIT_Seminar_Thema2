...
\begin{equation}
R_{lin} = \sqrt[5]{\frac{\frac{R}{12.92}}{(\frac{R+0.055}{1+0.055})^{12}}}
...
f(t)=\sqrt[3]{t}, if t > (\frac{6}{29})^{3}
f(t)=\frac{1}{3}(\frac{29}{6})^{3}t+\frac{4}{29}, otherwise
\end{equation}

Finally the last step is to calculate the color distance $\Delta E_{00}$ between two colors with the CIEDE2000 model. 
\begin{equation}
